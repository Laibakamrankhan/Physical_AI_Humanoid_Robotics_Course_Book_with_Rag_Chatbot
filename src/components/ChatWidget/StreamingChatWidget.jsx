...
const StreamingChatWidget = ({ documentContext = null }) => {
  ...
  // Handle sending a message with streaming capability
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      try {
        ...
        // This is a placeholder for when the backend supports streaming
        // For now, we'll use the regular chat API
        ...
        console.warn('Streaming not available, falling back to regular chat:', streamError);
