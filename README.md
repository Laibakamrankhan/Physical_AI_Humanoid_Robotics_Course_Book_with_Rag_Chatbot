...
## 🚀 Live Demo
- **Web App:** [View Live Site](https://physical-ai-humanoid-robotics-cours-chi.vercel.app/)
...
2. **Humanoid Robotics Basics:** Architecture, sensors, and actuators.
3. **ROS 2 Fundamentals:** The robotic nervous system.
4. **Digital Twin Simulation:** Using Gazebo and NVIDIA Isaac Sim.
5. **Vision-Language-Action (VLA) Systems:** How robots perceive and act.
6. **Capstone Project:** Building a simple AI-robot pipeline.
