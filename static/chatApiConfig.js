...
// This will be loaded as a static script in the HTML
...
const getApiBaseUrl = () => {
  ...
  if (typeof window !== 'undefined' && window.location.hostname.includes('github.io')) {
    ...
    return window.chatApiBaseUrl || 'https://your-production-backend.com'; // Replace with your actual production URL
  }

  // For development, use environment variable or default to localhost
  return window.chatApiBaseUrl || 'http://localhost:8000';
};
